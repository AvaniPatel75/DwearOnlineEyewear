...
export const routes: Routes = [
    ...
    {path:'viewAll/:product',component:ViewallComponent,canActivate:[authGuard]},
    ...
    {path:'gender/:gender',component:CategoryProductsComponent,canActivate:[authGuard]},
    {path:'offerUpTo/:num',component:OfferPageComponent,canActivate:[authGuard]},
